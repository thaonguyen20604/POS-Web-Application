    ...
    <script>
        function confirmLogout() {
            if (confirm("Are you sure you want to log out?")) {
                window.location.href = "../activate/logout.php";
            }
        }
    </script>  
    ...
    <div class="wrapper">
        ...
        <div class="row" id="home_module_list">
            <div class="module_item" title="Add, Update, Delete, and Search Customers.">
                <a href="../views/view_staffs.php"><img src="https://demo.opensourcepos.org/images/menubar/employees.png" border="0" alt="Menubar Image"></a>
                <a href="../views/view_staffs.php">Staffs</a>
            </div>
            ...
            <div class="module_item" title="Add, Update, Delete, and Search Products.">
            ...
            <div class="module_item" title="Add, Update, Delete, and Search Expenses.">
                <a href="../views/profile.php"><img src="https://demo.opensourcepos.org/images/menubar/expenses.png" border="0" alt="Menubar Image"></a>
